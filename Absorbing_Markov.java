...
//Calculates steady state probabilities of absorbing markov chains
//(With at least 1 steady state)
public class Absorbing_Markov {
    ...
    public static int[][] decimalToFract(double[] row, double terror) {
    ...
    public static int smallestValueIndex(int[] arr) {
        int index = 0;
